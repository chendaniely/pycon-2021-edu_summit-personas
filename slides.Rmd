...
subtitle: "PyCon 2021: Education Summit"  
author: 
  - "Daniel Chen, MPH"
date: '`r Sys.Date()`'
output:
...
.pull-left[
.center[
<img src='./figs/pycon2019-rstats.jpg' style="width:500px;" />
]
...
<center>
<img src="https://raw.githubusercontent.com/allisonhorst/stats-illustrations/master/rstats-artwork/tidydata_2.jpg" height="550" />
</center>
...
![](./figs/papers/tidy_paper-table_9-tb_messy.PNG)

---

## Tidy Data

![](./figs/papers/tidy_paper-table_10-tb_tidy_process.PNG)
...
Suppose you have the following Cytomegalovirus dataset of CMV reactivation among patients afer Allogenetic Hematopoietic Stem Cell Transplant (HSCT) in an excell sheet (first 10 rows shown below):

<center>
<img src="./figs/cmv_head.png" />
</center>

It is believed that the donor activating KIR genotype is a contributing factor for CMV reactivation after myeloablastive allogenetic HSCT. You want to do some data analysis to see what variables are associated with CMV reactivation.
...
2. Filter the data for individuals over the age of 65
...
3. Save filtered dataset as an Excel file to send to a colleague
...
4. Tidy the dataset so we have a donor CMV status and a patient CMV status in separate columns
...
5. Plot a histogram of the age distribution of our data
...
6. Fit a model (e.g., logistic regression) to see which variables are associated with patient CMV reactivation.
